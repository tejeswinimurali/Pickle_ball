...
from langchain_core.messages import SystemMessage, HumanMessage  # [web:1167]
...
def run_agent(question: str) -> str:
    ...
    # Pure greeting → just be friendly, no KB / web needed
    ...
    # For real questions, prepare KB fallback
