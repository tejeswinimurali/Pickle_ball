...
from langchain_core.messages import SystemMessage, HumanMessage  # for LangChain messages [web:1167]

urllib3.disable_warnings(urllib3.exceptions.InsecureRequestWarning)

OPENROUTER_API_KEY = os.environ.get("OPENROUTER_API_KEY", "")
OPENROUTER_BASE_URL = "https://openrouter.ai/api/v1"
MODEL_NAME = "meta-llama/llama-3.1-8b-instruct:free"  # free OpenRouter model [web:1074]
...
def search_kb(question: str) -> str:
    """Fallback answer built from a small offline sports KB."""
    q = question.lower()
...
def run_agent(question: str) -> str:
    """
    Online-first:
    - Try OpenRouter first, friendly + conversational.
    - If anything fails (no key, 402, timeout, etc.), fall back to KB.
    """
